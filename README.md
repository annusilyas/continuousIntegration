# java-calculator
Working repository for my pavadans

[![Build Status](https://travis-ci.org/BloodAxe/java-calculator.png?branch=master)](https://travis-ci.org/BloodAxe/java-calculator)

[![Code Coverage](https://img.shields.io/codecov/c/github/BloodAxe/java-calculator/master.svg)](https://codecov.io/github/BloodAxe/java-calculator?branch=master)
